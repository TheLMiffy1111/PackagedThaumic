...
public class BlockArcaneCrafter extends BlockBase {

	public static final BlockArcaneCrafter INSTANCE = new BlockArcaneCrafter();
	public static final Item ITEM_INSTANCE = new ItemBlock(INSTANCE).setRegistryName("packagedthaumic:arcane_crafter");
	public static final ModelResourceLocation MODEL_LOCATION = new ModelResourceLocation("packagedthaumic:arcane_crafter#normal");
	...
	protected BlockArcaneCrafter() {
		...
		setRegistryName("packagedthaumic:arcane_crafter");
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if(tileentity instanceof TileArcaneCrafter) {
			TileArcaneCrafter crafter = (TileArcaneCrafter)tileentity;
			if(!world.isRemote) {
