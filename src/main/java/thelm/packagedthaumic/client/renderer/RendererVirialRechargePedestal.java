...
public class RendererVirialRechargePedestal extends TileEntitySpecialRenderer<TileVirialRechargePedestal> {

	@Override
	public void render(TileVirialRechargePedestal te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
