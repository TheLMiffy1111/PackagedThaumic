...
public class GuiInfusionCrafter extends GuiContainerTileBase<ContainerInfusionCrafter> {

	public static final ResourceLocation BACKGROUND = new ResourceLocation("packagedthaumic:textures/gui/infusion_crafter.png");

	public GuiInfusionCrafter(ContainerInfusionCrafter container) {
		super(container);
		ySize = 173;
	}
