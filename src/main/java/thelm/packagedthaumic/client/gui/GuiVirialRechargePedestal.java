...
public class GuiVirialRechargePedestal extends GuiContainerTileBase<ContainerVirialRechargePedestal> {

	public static final ResourceLocation BACKGROUND = new ResourceLocation("packagedthaumic:textures/gui/virial_recharge_pedestal.png");

	public GuiVirialRechargePedestal(ContainerVirialRechargePedestal container) {
		super(container);
		ySize = 173;
	}
