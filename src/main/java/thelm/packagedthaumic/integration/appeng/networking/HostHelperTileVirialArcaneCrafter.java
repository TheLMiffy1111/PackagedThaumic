package thelm.packagedthaumic.integration.appeng.networking;
...
public class HostHelperTileVirialArcaneCrafter extends HostHelperTile<TileVirialArcaneCrafter> {

	public HostHelperTileVirialArcaneCrafter(TileVirialArcaneCrafter tile) {
		super(tile);
	...
	public void ejectItem() {
		...
		int endIndex = tile.isWorking ? 15 : 0;
