...
public class HostHelperTileClathrateEssenceFormer extends HostHelperTile<TileClathrateEssenceFormer> {

	public HostHelperTileClathrateEssenceFormer(TileClathrateEssenceFormer tile) {
		super(tile);
